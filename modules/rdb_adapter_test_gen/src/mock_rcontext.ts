// A minimal in-memory RContext for adapter fuzzers, built entirely on public
// APIs (dag / mvt / crypto). Mesh and fetchObject are omitted (histories never
// trigger sync or member bootstrap).
