// A minimal in-memory RContext for the conformance suite, built entirely on
// public APIs (dag / mvt / crypto) so it compiles as part of this library.
// It mirrors the subset of modules/rdb/test/mock_rcontext.ts the projection
// suite needs (create + load + getDag); mesh and fetchObject are intentionally
// omitted (the suite never triggers sync or member bootstrap).
...
import {
    RContext, RObject, Payload, RObjectConfig,
    TypeRegistryMap, RootScopedDag,
