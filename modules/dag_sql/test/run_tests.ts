import { schemaSuite, levelBackendSuite, topoBackendSuite, levelParitySuite, topoParitySuite, growthEventSuite, pollingObserverSuite, hardeningSuite } from "./sql_dag_tests.js";
...
async function main() {
    ...
    allTests.set(pollingObserverSuite.title, pollingObserverSuite.tests);
    allTests.set(hardeningSuite.title, hardeningSuite.tests);
